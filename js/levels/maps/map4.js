...
levels[4] = {
    init: () => {
        ...
        background = new Sprite({ position: { x: 0, y: 0, }, imageSrc: './img/levels/level4.png', })

        doors = [
            new Sprite({ position: { x: 204, y: 44, }, imageSrc: './img/obstacles/normalDoor.png',
                frameRate: 8, frameBuffer: 2, loop: false, autoplay: false, }),
        ]

        spikes = [
            new Sprite({ position: { x: 384, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
            new Sprite({ position: { x: 416, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
            new Sprite({ position: { x: 448, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
            new Sprite({ position: { x: 480, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
            new Sprite({ position: { x: 512, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
            new Sprite({ position: { x: 544, y: 300, }, imageSrc: './img/obstacles/spikes.png', }),
        ...
        fires = [
            new Sprite({ position: { x: 192, y: 416, }, imageSrc: './img/obstacles/fireTile.png', frameRate: 7, frameBuffer: 6, }),
            new Sprite({ position: { x: 224, y: 416, }, imageSrc: './img/obstacles/fireTile.png', frameRate: 7, frameBuffer: 6, }),
            new Sprite({ position: { x: 256, y: 416, }, imageSrc: './img/obstacles/fireTile.png', frameRate: 7, frameBuffer: 6, }),
            ...
            new Sprite({ position: { x: 320, y: 512, }, imageSrc: './img/obstacles/fireTile.png', frameRate: 7, frameBuffer: 6, }),
        ]

        waters = [
            new Sprite({ position: { x: 544, y: 96, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            new Sprite({ position: { x: 576, y: 96, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            new Sprite({ position: { x: 608, y: 96, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            ...
            new Sprite({ position: { x: 864, y: 512, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            new Sprite({ position: { x: 896, y: 512, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            new Sprite({ position: { x: 928, y: 512, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
            new Sprite({ position: { x: 960, y: 512, }, imageSrc: './img/obstacles/waterTile.png', frameRate: 8, frameBuffer: 6, }),
        ]

        ices = [
            new Sprite({ position: { x: 96, y: 32, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 96, y: 64, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 96, y: 96, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 96, y: 128, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 96, y: 160, }, imageSrc: './img/obstacles/iceTile.png', }),
            ...
            new Sprite({ position: { x: 576, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 608, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 640, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 672, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 704, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 736, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),
            new Sprite({ position: { x: 768, y: 352, }, imageSrc: './img/obstacles/iceTile.png', }),

            new Sprite({ position: { x: 800, y: 32, }, imageSrc: './img/obstacles/ice2.png', }),
            new Sprite({ position: { x: 608, y: 224, }, imageSrc: './img/obstacles/ice2.png', }),
            new Sprite({ position: { x: 32, y: 448, }, imageSrc: './img/obstacles/ice2.png', }),
            new Sprite({ position: { x: 800, y: 480, }, imageSrc: './img/obstacles/ice2.png', }),
        ]
    },
}